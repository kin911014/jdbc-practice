...
select a.emp_no as 사번,
 ...
 a.salary as 연봉  -- 사번 이름 급여많은순의 연봉
from salaries a,
employees b
...
select a.emp_no as 사번, concat(a.first_name,' ', a.last_name) as 이름,c.dept_name as 직책
...
select a.last_name as 사원이름, b.title as 직책, c.salary as 급여
...
select e.dept_name as 부서, avg(b.salary) as 평균연봉 
from employees a, salaries b, dept_emp c, dept_manager d, departments e
where a.emp_no = b.emp_no
and b.emp_no = c.emp_no
...
select a.title as 직책, avg(b.salary)
